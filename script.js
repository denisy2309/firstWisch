// --- Configuration ---
const N8N_WEBHOOK_URL = 'https://karisa-unmiserly-nicolasa.ngrok-free.dev/webhook/041be332-c2f9-44a6-a7ab-577b544c3753';
...
async function handleSend(text, isFromVoice = false) {
    ...
    try {
        ...
        const botResponseText = result.output.Output;
